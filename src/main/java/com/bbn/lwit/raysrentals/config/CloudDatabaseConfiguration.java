package com.bbn.lwit.raysrentals.config;
...
@Configuration
@EnableMongoRepositories("com.bbn.lwit.raysrentals.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.bbn.lwit.raysrentals.config.dbmigrations");
